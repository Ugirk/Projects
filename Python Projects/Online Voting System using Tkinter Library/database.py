from distutils.log import error  # type: ignore
import mysql.connector

# Connect with MySQL database    -Host Name     -PORT No.   -UserName    -Password    -Create database named `voting_system`
mydb = mysql.connector.connect(host="localhost", port=3306, user="onlinevote", password="oNline@#123", database="voting_system")
