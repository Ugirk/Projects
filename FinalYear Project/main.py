...
def dashboard(voterId):
    ...
    pollInput = Combobox(root, values=["CANDIDATE 1", "CANDIDATE 2","CANDIDATE 3","CANDIDATE 4"], font=(ARIAL, 13, "normal"), textvariable=poll)
    pollInput.place(x=400, y=225, width=200)
    districtLabel = Label(DashboardFrame, text="Select your Department", font=(ARIAL, 15, "normal"), bg="white")
    districtLabel.place(x=200, y=275)
    districtInput = Combobox(root, values=["Dep1", "Dep2","Dep3","Dep4","Dep5"], font=(ARIAL, 13, "normal"), textvariable=district)
...
def performDataAnalysis():
    parties = ["Candidate 1", "Candidate 2", "Candidate 3", "Candidate 4"]
    votes = [model.getPartyCount(party)[0] for party in parties]
    plt.figure(figsize=(8, 6))
    for i in range(len(parties)):
        plt.bar(parties[i], votes[i], color=['blue', 'green', 'red', 'purple'][i])
...
def AdminDashboard(regId):
    ...
    data_analysis_btn = Button(menu_bar, text="Perform Data Analysis", font=(ARIAL, 13, "normal"), command=performDataAnalysis, border=0, bg="white", fg="grey", anchor="w", padx=30)
    data_analysis_btn.place(x=0, y=406, width=249, height=50)
...
def votingResults():
    ...
    party1=Label(resultFrame,text="CANDIDATE 1",font=(LUCIDA_CONSOLE,15,"normal"),bg="white",fg="grey")
    party1.place(x=150,y=150)
    party2=Label(resultFrame,text="CANDIDATE 2",font=(LUCIDA_CONSOLE,15,"normal"),bg="white",fg="grey")
    party2.place(x=150,y=200)
    party3=Label(resultFrame,text="CANDIDATE 3",font=(LUCIDA_CONSOLE,15,"normal"),bg="white",fg="grey")
    party3.place(x=150,y=250)
    party4=Label(resultFrame,text="CANDIDATE 4",font=(LUCIDA_CONSOLE,15,"normal"),bg="white",fg="grey")
